...
**PickUp** è un'applicazione Flutter intuitiva progettata per aiutare gli sportivi a localizzare campi come ad esempio basket, calcio, tennis, beach volley e tanti altri intorno a loro. Utilizzando i dati di OpenStreetMap (via Overpass API), l'app mostra in tempo reale le strutture sportive disponibili sulla mappa.
